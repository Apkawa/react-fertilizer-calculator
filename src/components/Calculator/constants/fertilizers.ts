...
export const defaultFertilizers: FertilizerInfo[] = [
  ...
  {id: "Акварин Хвойный", npk: parseProfileStringToNPK("NO3=3 P2O5=11 K2O=35 MgO=4 S=9 Fe=0.054 Zn=0.014 Cu=0.01 Mn=0.042 Mo=0.004 B=0.02")},
  {id: "Аквамикс Л", npk: parseProfileStringToNPK("Fe=4.1 Mn=3 Zn=0.63 Mg=0.9 Cu=0.63 Mo=0.17 Co=0.06")},
