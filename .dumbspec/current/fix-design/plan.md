...
- [x] Result table: Cl + 8 micro rows render black-on-navy in dark (`SelectedListItem.tsx` hardcodes `text-black`, `ELEMENT_BG` covers only 7 macro elements) — theme text color when the row has no chip background
